...
import 'package:ponchao_app/Widgets/progressDialogue.dart';
import 'package:ponchao_app/assistance/assistant_methods.dart';
import 'package:ponchao_app/assistance/geofire_assistant.dart';
import 'package:ponchao_app/global/global.dart';
import 'package:ponchao_app/models/activeNearbyAvailableDrivers_model.dart';
import 'package:ponchao_app/screens/drawerScreen.dart';
import 'package:ponchao_app/screens/precisePickUpLocation_screen.dart';
import 'package:ponchao_app/screens/rateDriverScreen.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  initializeGeoFireListener() {
    ...
    Geofire.queryAtLocation(userCurrentPosition!.latitude, userCurrentPosition!.longitude, 10)!
      ...
      if(map != null) {
        ...
        switch(callBack) {
        //whenever any driver comes online
          case Geofire.onKeyEntered:
            ...
            break;
        //whenever any driver goes offline
  ...
  searchNearestOnlineDrivers(String selectedVehicleType) async {
    if(onlineNearByAvailableDriversList.length == 0) {
      ...
      Fluttertoast.showToast(msg: "No nearest Driver Available");
  ...
  updateArrivalTimeToUserPickUpLocation(driverCurrentPositionLatLng) async {
    if(requestPositionInfo == true){
      ...
      setState(() {
        driverRideStatus = "Driver is on their way!: " + directionDetailsInfo.duration_text.toString();
      });
  ...
  updateReachingTimeToUserDropOffLocation(driverCurrentPositionLatLng) async {
    if(requestPositionInfo == true){
      ...
      setState(() {
        driverRideStatus = "On The Way!: " + directionDetailsInfo.duration_text.toString();
      });
                      ...
                      Row(
                        ...
                        children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      tripDirectionDetailsInfo != null ? "PKR ${((AssistantMethods.calculateFareAmountFromOriginToDestination(tripDirectionDetailsInfo!) * 2) * 107).toStringAsFixed(1)}"
                                          : "null",
                                      style: TextStyle(
                                        color: Colors.grey,
                                      ),
                          ...
                          GestureDetector(
                            onTap: (){
                              setState(() {
                                selectedVehicleType = "Eco Car";
                              });
                            },
                            child: Container(
                              decoration: BoxDecoration(
                                color: selectedVehicleType == "Eco Car" ? (darkTheme ? Colors.amber.shade400 : Colors.blue) : (darkTheme ? Colors.black54 : Colors.grey[100]),
                                borderRadius: BorderRadius.circular(12),
                              ),
                              child: Padding(
                                padding: EdgeInsets.all(25.0),
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        color: selectedVehicleType == "Eco Car" ? (darkTheme ? Colors.black : Colors.white) : (darkTheme ? Colors.white : Colors.black),
                                      ),
                                    ),
                                    ...
                                    Text(
                                      tripDirectionDetailsInfo != null ? "PKR ${((AssistantMethods.calculateFareAmountFromOriginToDestination(tripDirectionDetailsInfo!) * 1.5) * 107).toStringAsFixed(1)}"
                                          : "null",
                                      style: TextStyle(
                                        color: Colors.grey,
                                      ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      tripDirectionDetailsInfo != null ? "PKR ${((AssistantMethods.calculateFareAmountFromOriginToDestination(tripDirectionDetailsInfo!) * 0.8) * 107).toStringAsFixed(1)}"
                                          : "null",
                                      style: TextStyle(
                                        color: Colors.grey,
                                      ),
